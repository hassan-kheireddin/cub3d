...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/16 12:07:27 by rabdel-f          #+#    #+#             */
/*   Updated: 2025/01/16 12:07:30 by rabdel-f         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//render_game() Initialize MiniLibX and set up the rendering
//environment for the game. Load textures, cast rays for 3D rendering,
//and handle user input via keyboard and window events
//
//rayscasting() function renders a single frame of the game using
//raycasting, which simulates the projection of rays from the player's
//viewpoint to determine what they see.
//
// calculate_current_ray() function computes the direction of the ray 
//for a specific column (or pixel) on the screen.
//
// render_collumn_pixel() function is responsible for rendering a vertical
//line of pixels on the screen for a given column, corresponding to a ray cast
//in the 3D environment. This function computes the appropriate texture
//coordinates and places the color on the screen based on the player's
//view and the texture information.